  ...
  useEffect(() => {
    const fetchCourseDetails = async () => {
      try {
        ...
        // Usar un solo endpoint que maneje toda la lógica en el backend:
        // 1. Verificar que el doctor tenga acceso al curso
        // 2. Obtener los detalles del curso
        // 3. Obtener la lista de estudiantes
        const courseId = params.courseId;
        const response = await axios.get(`http://localhost:3001/api/v1/doctors/me/courses/${courseId}/details`, {
          headers: {
            'Authorization': `Bearer ${accessToken}`
          }
        });
        
        const { course, students } = response.data.data || response.data || {};
    ...
    <div className="course-preview-container" ref={tableContainerRef}>
      ...
      <div className="course-info-card">
        <div className="card-header">
          <div className="course-title">
            <div className="title-text">
              <h2>Software Engineering <span className="course-code">C325</span></h2>
              <div className="course-badges">
                <div className="course-badge hours">
                  <div className="badge-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <div className="badge-content">
                    <span className="badge-label">Course Hours</span>
                    <span className="badge-value">3 Hours</span>
                  </div>
                </div>
                <div className="course-badge group">
                  <div className="badge-icon">
                  ...
                  <div className="badge-content">
                    <span className="badge-label">Group</span>
                    <span className="badge-value">Group 1</span>
                  </div>
                </div>
                <div className="course-badge level">
                  <div className="badge-icon">
                ...
                <div className="course-badge requirement">
                  ...
                  <div className="badge-content">
                    <span className="badge-value">Optional Requirement</span>
                  </div>
                </div>
              </div>
            </div>
            <div className="right-side">
              ...
              <div className="students-badge">
                ...
                <div className="badge-content">
                  <span className="badge-label">Enrolled Students</span>
                  <span className="badge-value">120 <span>Students</span></span>
                </div>
              </div>
            </div>
          </div>
